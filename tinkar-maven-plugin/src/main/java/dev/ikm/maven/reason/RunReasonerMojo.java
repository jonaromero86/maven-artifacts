...
import dev.ikm.tinkar.entity.graph.adaptor.axiom.*;
...
////		ClassifierResults classifierResults = collectResults(reasonerService.getReasonerConceptSet(), updateTransaction); //This method and others are in Komet code
////		reasonerService.processResults(); //This doesn't exists :(
